	...
	return (
		<div className="w-full">
			<Card className="h-full bg-transparent">
				<CardHeader>
					<CardTitle className="text-xl">کلید‌های SSH</CardTitle>
					<CardDescription>
						از کلید‌های ssh برای اتصال به سرور‌ها و اتصال به ریپوزیتوری‌های شخصی استفاده کنید.
					</CardDescription>
				</CardHeader>
					...
					{data?.length === 0 ? (
						<div className="flex flex-col items-center gap-3">
							...
							<span className="text-base text-muted-foreground">
								اولین کلید SSH خود را انتخاب کنید
							</span>
							<AddSSHKey>
								<Button>
						...
						<div className="space-y-8">
							<div className="flex flex-col gap-4">
								<div className="flex gap-4 text-xs px-3.5">
									<div className="col-span-2 basis-4/12">کلید</div>
									<div className="basis-3/12">اضافه شده در</div>
							...
							<AddSSHKey>
								<Button>
									<KeyRoundIcon className="size-4" /> اضافه کردن کلید جدید
								</Button>
							</AddSSHKey>
						</div>
					)}
