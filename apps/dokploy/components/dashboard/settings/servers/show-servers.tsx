		...
		<div className="p-6 space-y-6">
			...
			<div className="space-y-2 flex flex-row justify-between items-end">
				<div className="flex flex-col gap-2">
					<div>
						<h1 className="text-2xl font-bold">سرور‌ها</h1>
						<p className="text-muted-foreground">
							سرور‌های خود را اضافه کنید تا اپلیکیشن‌های خود ره به صورت ریموت دیپلوی کنید.
						</p>
					</div>
				...
				{sshKeys?.length === 0 && data?.length === 0 ? (
					<div className="flex flex-col items-center gap-3 min-h-[25vh] justify-center">
						...
						<span className="text-base text-muted-foreground">
							هیچ کلید ssh پیدا نشد. یک کلید ssh قبل از اضافه کردن سرور اضافه کنید.{" "}
							<Link
							...
							<span className="text-base text-muted-foreground">
								{!canCreateMoreServers ? (
									<AlertBlock type="warning">
										متاسفم، در این لحظه شما امکان اضافه کردن سرور بیشتری را ندارید. ,{" "}
										<Link href="/dashboard/settings/billing" className="text-primary">
											لطفا پلن مورد نظر خود را فعال کنید
										</Link>
									</AlertBlock>
