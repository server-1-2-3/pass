...
export const { useStepper, steps, Scoped } = defineStepper(
	{
		id: "requisites",
		title: "ملزومات",
		description: "چک کردن ملزومات قبل از شروع",
	},
	{
		id: "create-ssh-key",
		title: "کلید SSH",
		description: "کلید ssh برای اتصال به سرور",
	},
	{
		id: "connect-server",
		title: "اتصال",
		description: "اتصال به سرور و اضافه کردن",
	},
	{ id: "setup", title: "راه‌اندازی", description: "" },
	{ id: "verify", title: "تائیید", description: "سرور خود را تائیید کنید" },
	{ id: "complete", title: "اتمام", description: "اتمام راه اندازی اولین سرور" },
);
			...
			<DialogContent className="max-h-screen overflow-y-auto sm:max-w-7xl min-h-[75vh]">
				...
				<DialogHeader>
					<DialogTitle className="text-2xl text-center">
						به سرویس پس یک، دو، سه خوش آمدید 🎉
					</DialogTitle>
					<DialogDescription className="text-center max-w-xl mx-auto">
						ممنون ازشما که سرویس ما رو انتخاب کردین! 🚀 خیلی عالی میشه اگه قبل از شروع یک آنبورد داشته باشین. قبل از شروع، نیاز دارین که ریموت سرور خودتون رو اضافه کنید تا همه ویژگی‌ها براتون فعال بشه
						
					</DialogDescription>
				</DialogHeader>
				<div className="grid gap-4">
					<div className="flex justify-between">
						<h2 className="text-lg font-semibold">مراحلی که باید انجام بدین</h2>
							...
							requisites: () => (
								<div className="flex flex-col gap-2 border p-4 rounded-lg">
									<span className="text-primary text-base font-bold">
										قبل از شروع موارد زیر رو چک کنید تا بهترین تجربه رو با ما داشته باشین:
									</span>
									<div>
										<p className="text-primary text-sm font-medium">
											سیستم عامل‌هایی که از سمت ما پشتیبانی می‌شوند:
										</p>
									...
									<div>
										<p className="text-primary text-sm font-medium">
											شما نیاز خواید داشت تا یک سرور از سرویس یک،دو،سه تهییه کنید
										</p>
										<ul className="list-inside list-disc pl-4 text-sm text-muted-foreground mt-4">
											<li>
												<a
												...
												>
													خرید سرور از سرویس ابری یک، دو، سه
												</a>
											</li>

										</ul>
										<AlertBlock className="mt-4 px-4">
											شما میتوانید سرور خود را از هر جایی بگیرید اما برای پشتیبانی و تجربه بهتر، پیشنهاد ما سرور‌های یک دو سه میباشد
										</AlertBlock>
									</div>
								</div>
							),
