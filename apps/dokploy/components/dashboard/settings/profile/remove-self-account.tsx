	...
	return (
		<Card className="bg-transparent">
			<CardHeader className="flex flex-row gap-2 flex-wrap justify-between items-center">
				<div>
					<CardTitle className="text-xl">حذف اکانت</CardTitle>
					<CardDescription>
						اگه بری ولی جات خالیه
					</CardDescription>
				</div>
			</CardHeader>
			<CardContent className="space-y-2">
				...
				<div>
					<DialogAction
						title="مطمئن که دیگه میخوای بری؟"
						description="قبلش بگم که اگه حذفش کردی دیگه نمیتونی همین اکانت رو برگردونی !."
