...
export const DeleteApplication = ({ applicationId }: Props) => {
	...
	<DialogContent className="max-h-screen overflow-y-auto sm:max-w-lg">
		<DialogHeader>
			...
			<DialogDescription>
				این عمل قابل بازگشت نیست. این کار برنامه را به طور دائمی حذف خواهد کرد. اگر مطمئن هستید، لطفاً نام برنامه را وارد کنید تا این برنامه حذف شود.
			</DialogDescription>
		</DialogHeader>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input
										placeholder="نام برنامه را برای تأیید وارد کنید"
										{...field}
									/>
								</FormControl>
								<FormMessage />
