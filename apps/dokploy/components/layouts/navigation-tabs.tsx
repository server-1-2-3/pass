...
const getTabMaps = (isCloud: boolean) => {
	const elements: TabInfo[] = [
		{
			label: "پروژه‌ها",
			description: "پروژه‌های خود را بسازید یا مدیریت کنید",
	...
	if (!isCloud) {
		elements.push(
			{
				label: "مانیتورینگ",
				description: "مصرف منابع خود را مدیریت کنید",
				index: "/dashboard/monitoring",
				type: "monitoring",
			},
			{
				label: "ترفیک",
				tabLabel: "کانفیگ traefik",
				description: "تنظیمات traefik خود را مدیریت کنید",
			...
			{
				label: "داکر",
				description: "داکر خود را مدیریت کنید",
			...
			{
				label: "داکر سوارم",
				description: "داکر سوارم و سرور‌های خود را مدیریت کنید",
			...
			{
				label: "ریکوئست‌ها",
				description: "ریکوئست های خود را مدیریت کنید",
	...
	elements.push({
		label: "تنظیمات",
		description: "تنظیمات خود را مدیریت کنید",
		type: "settings",
		index: isCloud
